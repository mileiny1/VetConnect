    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vet', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='appointments', to='appointments.veterinarian')),
            ],
            options={
                'constraints': [models.UniqueConstraint(fields=('vet', 'appointment_date', 'appointment_time'), name='unique_vet_appointment')],
            },
        ),
    ]
